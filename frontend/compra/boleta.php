...
$pdf->Cell(71 ,10,'',0,0);
$pdf->Cell(59 ,1,utf8_decode('Factura electronica'),0,100);
$pdf->Cell(59 ,10,'',0,1);
$pdf->Cell(59 ,1,utf8_decode('Villa Manuela'),0,100);
$pdf->Cell(59 ,10,'',0,1);

$pdf->SetFont('Arial','B',15);
$pdf->Cell(71 ,5,'Sistema-Ventas',0,0);
$pdf->Cell(59 ,5,'',0,0);
...
require '../../backend/config/Conexion.php';
    $id = $_GET['id'];
    $stmt = $connect->prepare("SELECT * FROM orders_purchase WHERE idordpur= '$id'");
...
$pdf->Cell(30,10,number_format($row['total_price']),1,1,"R");
$pdf->SetX(120);
