...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off">
  ...
  <strong>Importante!</strong> Es importante rellenar los campos con &nbsp;<span class="badge-warning">*</span>
    ...
    <label for="email"><b>Runt del proveedor</b></label><span class="badge-warning">*</span>
    ...
    <input type="text" placeholder="ejm: *****" name="nomprv"  required>

    <label for="email"><b>Correo del proveedor</b></label>
    <input type="text" placeholder="ejm: ******@gmail.com" name="corrprv" >
