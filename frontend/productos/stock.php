    ...
    <div class="main-content">
        ...
        <main>
            ...
            <div class="page-header">
                ...
                <small>Home / Productos / Stock</small>
            </div>
...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off">
  ...
  <strong>Importante!</strong> Es importante rellenar los campos con &nbsp;<span class="badge-warning">*</span>
    ...
    <input disabled type="text" value="<?php echo $d->nomprd; ?>" placeholder="ejm: xxxxxxx"   required>

    <label for="email"><b>Stock del producto</b></label><span class="badge-warning">*</span>
    <input type="text" maxlength="3" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" value="<?php echo $d->stock; ?>" placeholder="ejm: xxxx" name="prdstock"  required>
