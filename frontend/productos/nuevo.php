    ...
    <div class="main-content">
        ...
        <main>
            <div class="page-header">
                ...
                <small>Home / Productos / Nuevo</small>
            </div>
            ...
            <div class="page-content">
                <form action="" enctype="multipart/form-data" method="POST" autocomplete="off">
                    <div class="containerss">
                        ...
                        <input type="text" placeholder="ejm: xxxxx" name="prdnom" required>
                    
                        <label for="email"><b>Descripción del producto</b></label><span class="badge-warning">*</span>
                        <textarea required name="prddes" id="consl" required placeholder="Descripcion..." style="height:200px"></textarea>
                    
                        <label for="email"><b>Precio del producto</b></label><span class="badge-warning">*</span>
                        <input type="text" onkeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" placeholder="ejm: xxxxxxxx" name="prdprec" required>
            ...
            <button onclick="window.location.href='mostrar.php'" class="registerbtn">Volver a Productos</button>
        </main>
    </div>
