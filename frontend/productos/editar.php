    ...
    <div class="main-content">
        ...
        <main>
            ...
            <div class="page-content">
                ...
                $id = $_GET['id'];
                $sentencia = $connect->prepare("SELECT productos.idprod, productos.codpro, productos.nomprd, productos.desprd, productos.precio, productos.stock, productos.state, productos.fere FROM productos WHERE idprod= '$id';");
                $sentencia->execute();
                    ...
                    <?php foreach ($data as $d): ?>
                        <form action="" enctype="multipart/form-data" method="POST" autocomplete="off">
                            <div class="containerss">
                                ...
                                <textarea required name="prddes" id="consl" required placeholder="Write something.." style="height:200px"><?php echo $d->desprd; ?></textarea>
