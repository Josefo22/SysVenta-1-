...
$sentencia = $connect->prepare("SELECT productos.idprod,productos.codpro ,productos.nomprd, productos.desprd, productos.foto, productos.precio, productos.stock, productos.state, productos.fere FROM productos ORDER BY productos.idprod DESC;");
 $sentencia->execute();
$data =  array();
if($sentencia){
