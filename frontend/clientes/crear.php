    ...
    <div class="main-content">
        ...
        <main>
            ...
            <div class="page-header">
                ...
                <small>Home / Propietarios / Perfil</small>
            </div>
...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off">
  ...
  <strong>Importante!</strong> Es importante rellenar los campos con &nbsp;<span class="badge-warning">*</span>
    ...
    <input type="text" value="<?php echo $d->nocl; ?> &nbsp; <?php echo $d->apcl; ?>" placeholder="ejm: jjelez" disabled>
  
    <label for="email"><b>Nombre del usuario cliente</b></label><span class="badge-warning">*</span>
    <input type="text" placeholder="ejm: jjelez" name="usrcl"  required>
