...
<body>
   ...
   <input type="checkbox" id="menu-toggle">
    <div class="sidebar">
        ...
        <h3>Sistema <span>Administrativo</spa></h3>
        </div>
    ...
    <div class="main-content">
        ...
        <main>
            ...
            <div class="page-header">
                ...
                <small>Home / Propietario / Nuevo</small>
            </div>
...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off">
  ...
  <strong>Importante!</strong> Es importante rellenar los campos con &nbsp;<span class="badge-warning">*</span>
    ...
    <input type="text" maxlength="10" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" placeholder="ejm: 77656756" name="numcl"  required>

    <label for="email"><b>Nombre del propietario</b></label><span class="badge-warning">*</span>
    <input type="text" placeholder="ejm: Juan" name="nomcl"  required>

    <label for="email"><b>Apellido del propietario</b></label><span class="badge-warning">*</span>
    <input type="text" placeholder="ejm: Agudelo" name="apecl"  required>

    <label for="email"><b>Torre del propietario</b></label><span class="badge-warning">*</span>
    <input type="text" maxlength="12" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" placeholder="ejm: 99898787" name="telcl"  required>

    <Label for="email"><b>Apartamento del propietario</b></Label><span class="badge-warning">*</span>
    <input type="text" maxlength="12" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" placeholder="ejm: 99898787" name="aptclien" required>
  ...
  <button onclick="window.location.href='mostrar.php'" class="registerbtn">Volver a Propietarios</button>
