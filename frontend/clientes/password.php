    ...
    <div class="main-content">
        ...
        <main>
            ...
            <div class="page-header">
                ...
                <small>Home / Propietarios / Contraseña</small>
            </div>
...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off">
  <div class="containerss">
    <h1>Cambiar contraseña del Propietario</h1>
  ...
  <strong>Importante!</strong> Es importante rellenar los campos con &nbsp;<span class="badge-warning">*</span>
    ...
    <label for="email"><b>Nombre Propietario</b></label>
    <input type="text" value="<?php echo $d->nocl; ?> &nbsp; <?php echo $d->apcl; ?>" placeholder="ejm: jjagudelo" disabled>
  
   
    <input type="hidden" name="clid" value="<?php echo $d->idcli; ?>">

    <label for="email"><b>Nueva contraseña del Propietario</b></label><span class="badge-warning">*</span>
